...
assert.doesNotMatch(history, /HISTORY_PROGRESS_CACHE_KEY/, 'retired history progress copy must stay removed');
assert.match(history, /migrateLegacyStorageKey\(hasRemoteHistory\(\) \? REMOTE_HISTORY_CACHE_KEY : LOCAL_HISTORY_KEY\)/, 'canonical history must be scoped');
